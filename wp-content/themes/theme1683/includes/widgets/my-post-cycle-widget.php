...
class MY_CycleWidget extends WP_Widget {
						...
						<?php } elseif($category=="portfolio"){ ?>
							...
							<div class="folio_cycle" id="folio-cycle">
								...
								<div class="folio_item">
									<div class="maxheight p2">
											<?php if(has_post_thumbnail()) { ?>
												<?php
												$thumb = get_post_thumbnail_id();
												$img_url = wp_get_attachment_url( $thumb,'full'); //get img URL
												$image = aq_resize( $img_url, 220, 122, true ); //resize & crop img
												?>
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit Text:', 'theme1683'); ?> <input class="widefat" id="<?php echo $this->get_field_id('limit'); ?>" name="<?php echo $this->get_field_name('limit'); ?>" type="text" value="<?php echo $limit; ?>" /></label></p>
